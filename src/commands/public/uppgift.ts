...
const uppgift_data = {
    ...
    description: "En laboration där du jobbar igenom grunderna i Python med värden, variabler och grundläggande datatyper.",
    date: "2017-08-28",
    author: {
        name: "Mikael Roos",
...
export const Uppgift: Command = {
    ...
    run: async (message: Message) => {
        ...
        axios.get('https://api.github.com/repos/dbwebb-se/website/contents/content/uppgift')
            .then(response => {
